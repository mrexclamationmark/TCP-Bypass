...
inline u32 tcp_bypass_ssthresh(struct sock *sk) {

	return 0;
}

inline void tcp_bypass_cong_avoid(struct sock *sk, u32 ack, u32 acked) {
}

inline void tcp_bypass_set_state(struct sock *sk, u8 new_state) {
}

inline void tcp_bypass_cwnd_event(struct sock *sk, enum tcp_ca_event ev) {
}

inline void tcp_bypass_in_ack_event(struct sock *sk, u32 flags) {
}

inline void tcp_bypass_pkts_acked(struct sock *sk, const struct ack_sample *sample) {
}

inline void tcp_bypass_cong_control(struct sock *sk, const struct rate_sample *rs) {
}

inline u32 tcp_bypass_undo_cwnd(struct sock *sk) {

	return 0;
}

inline u32 tcp_bypass_sndbuf_expand(struct sock *sk) {

	return 0;
}

inline size_t tcp_bypass_get_info(struct sock *sk, u32 ext, int *attr, union tcp_cc_info *info) {

	return 0;
}

inline void tcp_bypass_init(struct sock *sk) {
}
